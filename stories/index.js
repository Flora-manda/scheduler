...
//----- Start - InterviewerListItem Story -------//
const interviewer = {
  id: 1,
  name: "Sylvia Palmer",
...
//----- End - InterviewerListItem Story -------//

//----- Start - InterviewerList Story -------//
const interviewers = [
...
storiesOf("InterviewerList", module)
  ...
  .add("Initial", () => (
    <InterviewerList
      ...
      setInterviewer={(id) => action("onChange")(id)}
    />
  ))
  .add("Preselected", () => (
    <InterviewerList
...
//----- End - InterviewerList Story -------//

//----- Start - Appointment Story -------//
storiesOf("Appointment", module)
  ...
  .add("Show", () => (
    <Show onEdit={action("onEdit")} onDelete={action("onEdit")} />
  ))
  .add("Confirm", () => (
    <Confirm
